...
const Contents = [
    ...
    {
        type: NAV_TYPE_ICON,
        icon: "Portfolio/assets/images/icons/GitHub-Light.png",
        icon_light: "Portfolio/assets/images/icons/GitHub-Light.png",
        icon_dark: "Portfolio/assets/images/icons/GitHub-Dark.png",
        link: "https://github.com/SCastanedaMunoz",
        text: "GitHub",
    },
    {
        type: NAV_TYPE_ICON,
        icon: "Portfolio/assets/images/icons/LinkedIn.png",
        icon_light: "Portfolio/assets/images/icons/LinkedIn.png",
        icon_dark: "Portfolio/assets/images/icons/LinkedIn.png",
